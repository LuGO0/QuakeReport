    ...
    public static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                JSONObject tempFeature = featureArray.getJSONObject(i);
                JSONObject properties = tempFeature.getJSONObject("properties");
                ...
                result.add(new Earthquake(mag, place, time,url));
            }
